...
public static class OpenRouterModelProvider
{
    private static Dictionary<OpenRouterModelIds, ChatModels> Models { get; set; } = new()
    {
        ...
        { OpenRouterModelIds.Mythomax13B, new ChatModels("gryphe/mythomax-l2-13b",4096,0.00017999999999999998,0.00017999999999999998)},
        ...
        { OpenRouterModelIds.NousHermes2Mixtral8X7BSft, new ChatModels("nousresearch/nous-hermes-2-mixtral-8x7b-sft",32769,0.00054,0.00054)},
        ...
        { OpenRouterModelIds.MistralOpenOrca7B, new ChatModels("open-orca/mistral-7b-openorca",8192,0.0001425,0.0001425)},
        ...
        { OpenRouterModelIds.Mistral7BInstruct, new ChatModels("mistralai/mistral-7b-instruct",32768,0.0001,0.00025)},
        { OpenRouterModelIds.OpenHermes25Mistral7B, new ChatModels("teknium/openhermes-2.5-mistral-7b",4096,0.00017,0.00017)},
        { OpenRouterModelIds.OpenChat35, new ChatModels("openchat/openchat-7b",8192,0.0001,0.0001)},
        { OpenRouterModelIds.ToppyM7B, new ChatModels("undi95/toppy-m-7b",4096,0.00015,0.00015)},
        { OpenRouterModelIds.Lzlv70B, new ChatModels("lizpreciatior/lzlv-70b-fp16-hf",4096,0.0007,0.0008)},
        ...
        { OpenRouterModelIds.Dolphin26Mixtral8X7B, new ChatModels("cognitivecomputations/dolphin-mixtral-8x7b",32769,0.0005,0.0005)},
        { OpenRouterModelIds.NoromaidMixtral8X7BInstruct, new ChatModels("neversleep/noromaid-mixtral-8x7b-instruct",8000,0.008,0.008)},
        { OpenRouterModelIds.NousHermes2Mixtral8X7BDpo, new ChatModels("nousresearch/nous-hermes-2-mixtral-8x7b-dpo",32769,0.00027,0.00027)},
        ...
        { OpenRouterModelIds.GoogleGemma7B, new ChatModels("google/gemma-7b-it",8192,0.0001,0.0001)},
        { OpenRouterModelIds.DatabricksDbrx132BInstruct, new ChatModels("databricks/dbrx-instruct",32768,0.0006,0.0006)},
        { OpenRouterModelIds.MetaLlama38BInstruct, new ChatModels("meta-llama/llama-3-8b-instruct",8192,0.0001,0.0001)},
        ...
        { OpenRouterModelIds.ToppyM7BNitro, new ChatModels("undi95/toppy-m-7b:nitro",4096,0.00015,0.00015)},
        ...
        { OpenRouterModelIds.Llava13B, new ChatModels("haotian-liu/llava-13b",2048,0.01,0.01)},
